...
Modify or add SQLModel models for data and SQL tables in `./backend/app/models/`, API endpoints in `./backend/app/api/`, and service layer (Create, Read, Update, Delete) in `./backend/app/services/`.
