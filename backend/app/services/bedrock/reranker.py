...
class BedrockReranker:
    ...
    def rerank(
        ...
        Args:
            ...
            documents: List of dicts that must contain a 'content' key.
        ...
        Raises:
            ValueError: If query is empty or documents missing 'content' key.
        ...
        for i, doc in enumerate(documents):
            if "content" not in doc:
                raise ValueError(f"Document at index {i} missing 'content' key")
        ...
        try:
            ...
            raise RuntimeError(f"Bedrock rerank API call failed: {e}") from e
