...
variable "ecr_api_endpoint_subnet_ids" {
  description = "The ID of one or more subnets in which to create a network interface for ECR API endpoint"
  type        = list(string)
  default     = []
}
...
variable "ecr_dkr_endpoint_subnet_ids" {
  description = "The ID of one or more subnets in which to create a network interface for ECR DKR endpoint"
  type        = list(string)
  default     = []
}
...
variable "ecs_endpoint_subnet_ids" {
  description = "The ID of one or more subnets in which to create a network interface for ECS endpoint"
  type        = list(string)
  default     = []
}
...
variable "enable_ecs_agent_endpoint" {
  description = "Should be true if you want to provision an ECS Agent endpoint to the VPC"
  type        = bool
  default     = false
}
...
variable "ecs_agent_endpoint_subnet_ids" {
  description = "The ID of one or more subnets in which to create a network interface for ECS Agent endpoint"
  type        = list(string)
  default     = []
}
...
variable "ecs_telemetry_endpoint_subnet_ids" {
  description = "The ID of one or more subnets in which to create a network interface for ECS Telemetry endpoint"
  type        = list(string)
  default     = []
}
...
variable "logs_endpoint_subnet_ids" {
  description = "The ID of one or more subnets in which to create a network interface for CloudWatch Logs endpoint"
  type        = list(string)
  default     = []
}
...
# VPC Endpoints - Interface - Secrets Manager
...
variable "secretsmanager_endpoint_subnet_ids" {
  description = "The ID of one or more subnets in which to create a network interface for Secrets Manager endpoint"
  type        = list(string)
  default     = []
}
...
variable "ssm_endpoint_subnet_ids" {
  description = "The ID of one or more subnets in which to create a network interface for SSM endpoint"
  type        = list(string)
  default     = []
}
...
variable "ssmmessages_endpoint_subnet_ids" {
  description = "The ID of one or more subnets in which to create a network interface for SSM Messages endpoint"
  type        = list(string)
  default     = []
}
...
variable "ec2messages_endpoint_subnet_ids" {
  description = "The ID of one or more subnets in which to create a network interface for EC2 Messages endpoint"
  type        = list(string)
  default     = []
}
