...
resource "aws_ecr_repository" "backend" {
  name                 = "${var.context.project}-${var.context.environment}-backend"
    ...
    rules = [
      {
        ...
        selection = {
          tagStatus     = "tagged"
          tagPrefixList = ["${var.context.environment}-"]
...
resource "aws_ecr_repository" "frontend" {
  name                 = "${var.context.project}-${var.context.environment}-frontend"
  image_tag_mutability = "MUTABLE"
