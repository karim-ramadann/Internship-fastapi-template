...
export class RagService {
     ...
     * @throws ApiError
     */
    public static query(data: RagQueryData): CancelablePromise<RagQueryResponse> {
        return __request(OpenAPI, {
            method: 'POST',
     ...
     * @throws ApiError
     */
    public static stats(): CancelablePromise<RagStatsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
